openerp.vuente_iframe_help = function (session) {
    var _t = session.web._t,
       _lt = session.web._lt;

    var web_iframe = session.vuente_iframe_help;

    session.web.client_actions.add('vuente_iframe_help.iframe', 'session.vuente_iframe_help.iframe');
    web_iframe.iframe = session.web.Widget.extend({
        template: 'vuente_iframe_help.iframe',
